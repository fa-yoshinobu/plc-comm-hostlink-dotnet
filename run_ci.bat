...
echo [1/10] Building library project...
...
echo [2/10] Testing API reference generator helpers...
...
echo [3/10] Validating API reference...
...
echo [4/10] Building test project...
...
echo [7/10] Building user-facing sample projects...
...
echo [8/10] Validating high-level XML docs coverage...
...
echo [9/10] Validating sample inventory...
...
echo [10/10] Validating release workflow identity guards...
